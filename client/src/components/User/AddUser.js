        ...
        <div className="content">
            ...
            <div class="card-box">
              ...
              <div className="row">
                ...
                <div className="col-lg-8 offset-lg-2">
                <form id="addUserForm" name='addUserForm' onSubmit={handleSubmit}>
                    <div className="row">
                      ...
                      <div className="col-sm-6">
                        <div className="form-group">
                          <label>Phone </label>
                          <input name="phone" className="form-control" type="text" required value={phone} onChange={(event) => setPhone(event.target.value)} />
                        </div>
                      </div>
                      <div className="col-sm-6">
                        <div className="form-group">
